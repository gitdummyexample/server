...
let jsx_runtime_1 = require('react/jsx-runtime');
let react_1 = require('react');
let axios_1 = __importDefault(require('axios'));
require('./App.css');
function App() {
    let _a = (0, react_1.useState)(''), message = _a[0], setMessage = _a[1];
    let _b = (0, react_1.useState)({ fileName: '' }), fileName = _b[0], setFileName = _b[1];
    let _c = (0, react_1.useState)(), number1 = _c[0], setNumber1 = _c[1];
    let _d = (0, react_1.useState)(), number2 = _d[0], setNumber2 = _d[1];
    let _e = (0, react_1.useState)(0), total = _e[0], setTotal = _e[1];
    (0, react_1.useEffect)(() => {
    ...
    let handleSubmit = function(event) {
        ...
        axios_1.default.post('http://localhost:5059/Add', { number1: number1, number2: number2 })
            .then((res) => {
                console.log(res);
