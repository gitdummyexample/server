...
if (ENVIRONMENT_IS_NODE) {
    ...
    numericVersion = numericVersion[0] * 10000 + numericVersion[1] * 100 + Number(numericVersion[2].split('-')[0]);
...
function checkStackCookie() {
    ...
    let cookie1 = HEAPU32[max >> 2];
    let cookie2 = HEAPU32[max + 4 >> 2];
    ...
    if (typeof globalThis !== 'undefined' && !Object.getOwnPropertyDescriptor(globalThis, sym)) {
        Object.defineProperty(globalThis, sym, {
            ...
            get: function() {
                ...
                msg = `${msg } (e.g. -sDEFAULT_LIBRARY_FUNCS_TO_INCLUDE='${ librarySymbol }')`;
                if (isExportedByForceFilesystem(sym)) {
                    msg = `${msg }. Alternatively, forcing filesystem support (-sFORCE_FILESYSTEM) can export this for you`;
                }
                warnOnce(msg);
                return undefined;
            }
...
var _addTwo = Module._addTwo = createExportWrapper('addTwo');
